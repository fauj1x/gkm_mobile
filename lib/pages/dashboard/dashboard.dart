import 'dart:typed_data'; // Tambahan dari merge UI teman Anda
      ...
      if (userId != 0) {
        ...
        if (profiles.isNotEmpty) {
          _userProfile = profiles.firstWhere(
            ...
            orElse: () => UserProfile( // Default jika tidak ditemukan di antara profil yang ada
            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      Row( // Mengubah SizedBox menjadi Row untuk tombol import/export
                        children: [
                          // Tombol Import (kiri)
                          Expanded(
                            child: SizedBox(
                      ...
                      const SizedBox(height: 16),
                      Padding( // Menambahkan Padding untuk header tabel
                        ...
                        child: Row(
                          children: [
                            Expanded(
                              flex: 3,
                              child: Padding(
                                padding: const EdgeInsets.only(left: 8.0), // Padding kiri untuk teks
                                child: Text(
                                  'Tahun Ajaran',
                                  style: GoogleFonts.poppins(
                                    fontWeight: FontWeight.bold,
                      ...
                      const Divider(height: 16), // Divider dengan tinggi
                      for (var tahunAjaran in tahunAjaranList) ...[ // Menggunakan tahunAjaranList
                        Padding(
                            ...
                            children: [
                              Expanded(
                                ...
                                child: Padding(
                                  ...
                                  child: Text(
                                    tahunAjaran.tahunAjaran, // Mengambil tahunAjaran dari model
                                    style: GoogleFonts.poppins(
                              ...
                              Expanded(
                                ...
                                child: Padding(
                                  padding: const EdgeInsets.only(left: 8.0),
                                  child: Text(
                                    (tahunAjaran.semester == 'ganjil') // Logika untuk menampilkan Ganjil/Genap
                                        ? 'Ganjil'
                                        : 'Genap',
                                    style: GoogleFonts.poppins(
                                      fontWeight: FontWeight.w300,
                                      ...
                                      child: SizedBox(
                                        ...
                                        child: ElevatedButton.icon(
                                          onPressed: () {
                                            Navigator.push(
                                              context,
                                              MaterialPageRoute(builder: (context) => UbahData(tahunAjaran: tahunAjaran)),
                                            );
                                          },
                                          style: ElevatedButton.styleFrom(
              ...
              onPressed: () async {
                ...
                try {
                  if (kIsWeb) {
                    ...
                    // TODO: Tambahkan logika untuk mengunggah fileBytes ke API
                    // Contoh: await apiService.uploadFileBytes(fileBytes, fileName, "excel-import-endpoint");
                  } else {
                    if (filePath == null) {
                      throw Exception('File path tidak tersedia.');
                    }
                    // TODO: Tambahkan logika untuk mengunggah filePath ke API
                    // Contoh: await apiService.uploadFile(filePath, "excel-import-endpoint");
                  }
