...
import 'package:gkm_mobile/models/publikasi_ilmiah_dosen.dart';
import 'package:gkm_mobile/models/tahun_ajaran.dart';
import 'package:gkm_mobile/services/api_services.dart';
import 'package:shared_preferences/shared_preferences.dart';

class PublikasiIlmiahDosen extends StatefulWidget {
  final TahunAjaran tahunAjaran;
  const PublikasiIlmiahDosen({Key? key, required this.tahunAjaran}) : super(key: key);
  @override
  PublikasiIlmiahDosenState createState() => PublikasiIlmiahDosenState();
}

class PublikasiIlmiahDosenState extends State<PublikasiIlmiahDosen> {
  // final List<String> yesNoOptions = ['Tidak', 'Ya'];
  List<PublikasiIlmiahDosenModel> dataList = [];
  ApiService apiService = ApiService();
  String menuName = "Kinerja Dosen";
  String subMenuName = "Publikasi & Pagelaran Ilmiah";
  String endPoint = "kinerja-publikasi";
  int userId = 0;
  ...
  Future<void> _addData(Map<String, dynamic> newData) async {
    try {
      await apiService.postData(PublikasiIlmiahDosenModel.fromJson, newData, endPoint);
      _fetchData();
    } catch (e) {
  ...
  Future<void> _editData(int index, Map<String, dynamic> updatedData) async {
    try {
      await apiService.updateData(
          PublikasiIlmiahDosenModel.fromJson, index, updatedData, endPoint);
      _fetchData();
    } catch (e) {
                          ...
                          Container(
                            ...
                            child: Row(
                              children: [
                                ...
                                _headerCell("Judul Artikel", 100),
                                _headerCell("Jenis Artikel", 100),
              ...
              children: [
                ...
                TextField(
                  ...
                  decoration: const InputDecoration(
                    ...
                    hintText: 'Masukkan Jenis Artikel',
                  ),
                ),
                TextField(
            ...
            TextButton(
              onPressed: () {
                _addData({
                  ...
                  'jenis_artikel': controller3.text,
  ...
  void _showEditDialog(int id, Map<String, dynamic> currentData) {
    ...
    controller3.text = currentData['jenis_artikel'] ?? '';
