...
class HkiPaten extends StatefulWidget {
  final TahunAjaran tahunAjaran;
  const HkiPaten({Key? key, required this.tahunAjaran})
      : super(key: key);
  @override
  HkiPatenState createState() => HkiPatenState();
}

class HkiPatenState extends State<HkiPaten> {
  ...
  String subMenuName = "HKI (Paten)";
  String endPoint = "luaran-hkipaten";
  int userId = 0;
