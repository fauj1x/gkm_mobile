...
class HkiHakCipta extends StatefulWidget {
  final TahunAjaran tahunAjaran;
  const HkiHakCipta({Key? key, required this.tahunAjaran})
      : super(key: key);
  @override
  HkiHakCiptaState createState() => HkiHakCiptaState();
}

class HkiHakCiptaState extends State<HkiHakCipta> {
  ...
  String subMenuName = "HKI (Hak Cipta)";
  String endPoint = "luaran-hkihakcipta";
  int userId = 0;
