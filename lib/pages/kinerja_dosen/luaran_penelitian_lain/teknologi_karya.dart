...
class TeknologiKarya extends StatefulWidget {
  final TahunAjaran tahunAjaran;
  const TeknologiKarya({Key? key, required this.tahunAjaran})
      : super(key: key);
  @override
  TeknologiKaryaState createState() => TeknologiKaryaState();
}

class TeknologiKaryaState extends State<TeknologiKarya> {
  ...
  String subMenuName = "Teknologi Karya";
  String endPoint = "luaran-teknologikarya";
  int userId = 0;
  ...
  List<LuaranPenelitianLainAioModel> filterByIdAndTahun(
      List<LuaranPenelitianLainAioModel> list,
      int userId,
      int tahunAjaranId) {
