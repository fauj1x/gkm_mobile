...
class PkmDtps extends StatefulWidget {
  ...
  const PkmDtps({Key? key, required this.tahunAjaran})
      : super(key: key);
  @override
  PkmDtpsState createState() => PkmDtpsState();
}

class PkmDtpsState extends State<PkmDtps> {
  ...
  String subMenuName = "PkM DTPS"; // Sesuaikan jika ada sub menu
  String endPoint = "kinerja-pkmdtps"; // Sesuaikan endpoint API jika berbeda
  int userId = 0;
  ...
  List<PenelitianDtpsModel> filterByIdAndTahun(
      List<PenelitianDtpsModel> list,
      int userId,
      int tahunAjaran) {
