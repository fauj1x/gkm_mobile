...
class MasaStudiLulusan extends StatefulWidget {
  ...
  const MasaStudiLulusan({Key? key, required this.tahunAjaran}) : super(key: key);

  @override
  _MasaStudiLulusanState createState() => _MasaStudiLulusanState();
}

class _MasaStudiLulusanState extends State<MasaStudiLulusan> {
  int userId = 0;
      ...
      setState(() {
        dataList = [
          [
            "1",
            "Masa Studi Lulusan",
            data["Tabel 8.c Masa Studi Lulusan"]["count"].toString(),
            data["Tabel 8.c Masa Studi Lulusan"]["status"]
          ],
