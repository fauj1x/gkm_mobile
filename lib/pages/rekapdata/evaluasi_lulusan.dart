...
class EvaluasiLulusan extends StatefulWidget {
  final TahunAjaran tahunAjaran;
  const EvaluasiLulusan({Key? key, required this.tahunAjaran}) : super(key: key);

  @override
  _EvaluasiLulusanState createState() => _EvaluasiLulusanState();
}

class _EvaluasiLulusanState extends State<EvaluasiLulusan> {
  int userId = 0;
