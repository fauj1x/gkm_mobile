...
class IpkLulusan extends StatefulWidget {
  ...
  const IpkLulusan({Key? key, required this.tahunAjaran}) : super(key: key);

  @override
  _IpkLulusanState createState() => _IpkLulusanState();
}

class _IpkLulusanState extends State<IpkLulusan> {
  int userId = 0;
      ...
      setState(() {
        dataList = [
          [
            "1",
            "IPK Lulusan",
            data["Tabel 8.a IPK Lulusan"]["count"].toString(),
            data["Tabel 8.a IPK Lulusan"]["status"]
          ],
