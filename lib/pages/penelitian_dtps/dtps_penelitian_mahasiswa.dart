...
class DtpsPenelitianMahasiswa extends StatefulWidget {
  final TahunAjaran tahunAjaran;
  const DtpsPenelitianMahasiswa({Key? key, required this.tahunAjaran}) : super(key: key);
  @override
  DtpsPenelitianMahasiswaState createState() => DtpsPenelitianMahasiswaState();
}

class DtpsPenelitianMahasiswaState extends State<DtpsPenelitianMahasiswa> {
  // final List<String> yesNoOptions = ['Tidak', 'Ya'];
  List<DtpsAioModel> dataList = [];
  ApiService apiService = ApiService();
  String menuName = "Penelitian DTPS";
  String subMenuName = "yang Melibatkan Mahasiswa";
  String endPoint = "penelitian-mahasiswa";
  int userId = 0;
                          ...
                          Container(
                            ...
                            child: Row(
                              children: [
                                ...
                                _headerCell("Judul Kegiatan", 100),
            ...
            child: Column(
              children: [
                ...
                TextField(
                  controller: controller4,
                  decoration:
                  const InputDecoration(labelText: "Judul Kegiatan"),
                ),
                TextField(
                  controller: controller5,
                  decoration:
